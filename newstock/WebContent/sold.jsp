...
<html>
<head><script type="text/javascript" src="jscripts/addexitproduct.js"></script>
...
out.print(msg);
     ...
     %>
		...
		<form action="SoldServlet" onsubmit="return validateForm(this);" method="post">
			select product <select
				style="height: 22px; width: 167px; border-radius: 10px;" name="product"onchange="showAid(this.value)" id="product"><option
			...
			<br> select Article id <select
				style="height: 22px; width: 167px; border-radius: 10px;" name="aid" id="aid"onchange="showBrand(dm product)"><option
					value="-1">------select-------</option>
